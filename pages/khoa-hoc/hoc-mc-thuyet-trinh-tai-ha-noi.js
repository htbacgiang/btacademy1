  ...
  return (
    <DefaultLayout meta={meta}>
      ...
      <section className="relative hero-bg-gradient full-screen-bg overflow-hidden bg-gradient-to-br from-green-50 via-white to-emerald-50 pb-8 pt-10 md:pb-10 md:pt-14">
        ...
        <div className="container mx-auto -translate-y-2 px-5 md:px-0 md:-translate-y-6">
          <div className="grid items-center gap-8 lg:grid-cols-[1fr_1.15fr_0.9fr]">
            <div className="z-20 space-y-7 lg:-translate-y-8">
              ...
              <h1 className="break-words text-3xl font-bold leading-[1.15] text-gray-900 md:text-3xl">
              ...
              <div className="flex flex-wrap items-center gap-3 pt-1 sm:flex-nowrap sm:gap-4">
                <Link
                  href="/khoa-hoc"
                  className="inline-flex shrink-0 items-center gap-2 whitespace-nowrap rounded-lg bg-gradient-to-r from-[#4f46e5] to-[#4338ca] px-4 py-3 text-sm font-semibold text-white shadow-md shadow-indigo-200/60 transition-all hover:-translate-y-0.5 sm:px-5"
                >
                  Tất cả khóa học
                ...
                <div className="min-w-0 flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-bold text-[#131a53] sm:text-base">500+ học viên</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <section className="mt-4 mb-4">
            <div className="bg-white p-4 rounded-lg">
              <div className="space-y-1.5">
                ...
                <p><strong>📧 Email:</strong> <a href="mailto:contact@btacademy.com.vn">contact@btacademy.com.vn</a></p>
              </div>
            </div>
          </section>
        </div>
