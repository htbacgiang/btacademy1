...
const Editor: FC<Props> = ({
  ...
  const updateAuthor: ChangeEventHandler<HTMLSelectElement> = ({ target }) =>
    setPost({ ...post, author: target.value });
  ...
  useEffect(() => {
    if (initialValue) {
      const authorId = typeof initialValue.author === "object" && initialValue.author
        ? (initialValue.author as any)._id
        : initialValue.author || "";

      setPost({ ...initialValue, author: authorId });
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 space-y-3">
            <div className="space-y-2">
              ...
              <div>
                ...
                <select
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#105d97] focus:border-transparent outline-none bg-white text-gray-900"
