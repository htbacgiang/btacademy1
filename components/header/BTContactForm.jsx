...
export default function BTContactForm() {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div ref={leftSectionRef} className="opacity-0 md:block hidden">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">
                Bắt đầu hành trình chinh phục kỹ năng MC cùng BT Academy
              </h3>
              <p className="text-lg text-gray-600 mb-4">
                Để lại thông tin để nhận lộ trình đào tạo cá nhân hóa và tư vấn trực tiếp từ các chuyên gia hàng đầu. Chúng tôi sẽ giúp bạn tự tin tỏa sáng với giọng nói và phong thái chuyên nghiệp nhất.
              </p>
              <ul className="space-y-3 text-gray-700">
                <li className="flex items-center gap-2">
                  ...
                  Tư vấn lộ trình học phù hợp nhất
                </li>
                <li className="flex items-center gap-2">
                  <span className="w-6 h-6 rounded-full bg-green-100 text-green-600 flex items-center justify-center text-xs font-bold">✓</span>
                  Nhận ưu đãi học phí lên đến 20%
                </li>
                <li className="flex items-center gap-2">
                  <span className="w-6 h-6 rounded-full bg-green-100 text-green-600 flex items-center justify-center text-xs font-bold">✓</span>
                  Bộ tài liệu luyện giọng độc quyền miễn phí
                </li>
              </ul>
            </div>
            ...
            <div ref={rightSectionRef} className="opacity-0">
              <form
                ...
                className="space-y-4"
                role="form"
                aria-label="Form đăng ký tư vấn BT Academy"
              >
                ...
                <div>
                  <textarea
                    ...
                    onChange={handleChange}
                    placeholder="Yêu cầu tư vấn của bạn (ví dụ: khóa học MC nhí, luyện giọng, thuyết trình...)"
                ...
                <button
                  ...
                  className="w-full bg-green-600 text-white font-bold py-4 rounded-xl hover:bg-green-700 transition-all shadow-lg shadow-green-900/10 flex items-center justify-center gap-2"
                  aria-disabled={status === "Đang gửi..."}
                >
                  {status === "Đang gửi..." ? "Đang gửi..." : "Đăng ký nhận tư vấn ngay"} <span>→</span>
                </button>
              </form>
              {status && (
                <p
