          ...
          <div className="flex justify-between items-center h-20">
                      ...
                      <div className="space-y-1">
                        {item.name === "Về chúng tôi" ? (
                          <>
                            <Link 
                              href="/gioi-thieu" 
                              className="group/item dropdown-item flex items-center px-6 py-3 text-sm text-gray-700 hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50 hover:text-blue-700 transition-all duration-200 relative overflow-hidden"
                            >
                              <div className="w-2 h-2 rounded-full bg-gradient-to-r from-blue-400 to-purple-500 mr-3 group-hover/item:scale-125 transition-transform duration-200"></div>
            ...
            <div className="hidden lg:block">
              <button 
                ...
                className="bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white px-6 py-3 rounded-full font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
              >
                Đăng ký ngay
              </button>
            </div>
            ...
            <div className="lg:hidden">
              <button
                ...
                className="p-2 text-gray-700 hover:text-blue-600 focus:outline-none rounded-lg hover:bg-blue-50 transition-all duration-200"
              >
