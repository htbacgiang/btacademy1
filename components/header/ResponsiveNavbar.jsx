                ...
                <div className="flex items-center">
                  ...
                  {item.hasDropdown && (
                    <button
                      ...
                      aria-label={activeDropdown === index ? `Thu gọn danh mục ${item.name}` : `Mở rộng danh mục ${item.name}`}
                      className="p-2 rounded-xl hover:bg-emerald-50 transition-all duration-300 ml-2 group/btn"
                    >
                      {activeDropdown === index ? (
                        <HiChevronUp aria-hidden="true" className="w-5 h-5 text-gray-600 group-hover/btn:text-emerald-700 transition-colors duration-300" />
                      ) : (
                        <HiChevronDown aria-hidden="true" className="w-5 h-5 text-gray-600 group-hover/btn:text-emerald-700 transition-colors duration-300" />
                      )}
                    </button>
                  )}
                </div>
        ...
        <div className="p-6 border-t border-gray-100 bg-gradient-to-r from-gray-50 to-white">
          ...
          <div className="text-center">
            ...
            <div className="flex justify-center space-x-4">
              {[
                { name: "Facebook", icon: FaFacebook, color: "hover:bg-emerald-600", href: "https://www.facebook.com/profile.php?id=61564432965502" },
                { name: "Twitter", icon: FaTwitter, color: "hover:bg-emerald-600", href: "#" },
                { name: "LinkedIn", icon: FaLinkedin, color: "hover:bg-emerald-600", href: "#" },
                { name: "Instagram", icon: FaInstagram, color: "hover:bg-emerald-600", href: "#" }
              ].map((social, index) => (
                <Link
                  key={index}
                  href={social.href}
