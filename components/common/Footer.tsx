...
const Footer: React.FC = () => {
  ...
  const footerLinks = {
    ...
    courses: [
      { name: "Đào tạo MC Nhí", href: "/khoa-hoc/mc-nhi-co-ban" },
      { name: "Khóa học MC Cơ bản", href: "/khoa-hoc/khoa-hoc-mc-co-ban" },
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
              ...
              <div className="lg:col-span-2">
                <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
                  {/* Company */}
                  <div>
                    <h4 className="text-lg font-bold mb-6 text-white hover:text-green-400 transition-colors duration-300 border-b border-gray-800 pb-2">Thông tin</h4>
                  ...
                  {/* Courses */}
                  <div>
                    <h4 className="text-lg font-bold mb-6 text-white hover:text-green-400 transition-colors duration-300 border-b border-gray-800 pb-2">Khóa học</h4>
                    <ul className="space-y-3">
                  ...
                  {/* Support */}
                  <div>
                    <h4 className="text-lg font-bold mb-6 text-white hover:text-green-400 transition-colors duration-300 border-b border-gray-800 pb-2">Hỗ trợ</h4>
                    <ul className="space-y-3">
              ...
              {/* Contact Info */}
              <div className="lg:col-span-1">
                <h4 className="text-lg font-bold mb-6 text-white hover:text-green-400 transition-colors duration-300 border-b border-gray-800 pb-2">Liên hệ</h4>
                  ...
                  <div className="flex space-x-3">
                    {socialLinks.map((social, index) => {
                      ...
                      return (
                        ...
                        >
                          <Icon className="text-white transition-colors duration-300" size={18} aria-hidden="true" />
                        </a>
                      );
                    })}
                  </div>
