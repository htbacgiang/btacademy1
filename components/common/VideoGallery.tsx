...
const VideoGallery: React.FC<VideoGalleryProps> = ({
  ...
  const scrollToGalleryTop = () => {
    if (!scrollToTopOnPaginate || typeof window === "undefined") return;

    const sectionTop = gallerySectionRef.current?.getBoundingClientRect().top;
    if (sectionTop == null) return;

    const top = sectionTop + window.scrollY - scrollOffset;
  ...
  const handlePageChange = (page: number) => {
    ...
    // Wait for the new page state to be applied before scrolling.
  ...
  return (
    <>
      <section ref={gallerySectionRef} className="py-8 md:py-10 bg-white">
        <div className="container mx-auto px-2 md:px-4">
          ...
          <div className="mx-auto w-full">
            ...
            {showPagination && totalPages > 1 && (
              <div className="mt-4 flex flex-wrap items-center justify-center gap-2 px-2 md:mt-6">
