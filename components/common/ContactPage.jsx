...
export default function ContactPage() {
  ...
  const contactInfo = {
    ...
    fanpage: "https://www.facebook.com/profile.php?id=61564432965502",
    workingHours: {
  ...
  const socialLinks = [
    { name: "Facebook", icon: FaFacebookF, url: "https://www.facebook.com/profile.php?id=61564432965502", color: "bg-blue-600" },
    { name: "YouTube", icon: FaYoutube, url: "https://youtube.com/@B%C3%ADchTh%E1%BB%A7y-h2r", color: "bg-red-600" },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="space-y-6 mb-8">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a 
                      ...
                      className="text-green-500 hover:text-green-600 font-bold text-lg transition-colors"
                    >
                      {contactInfo.phone}
                    </a>
                  </div>
                ...
                <div className="flex items-start space-x-4">
                  <div className="w-12 h-12 bg-green-100 rounded-2xl flex items-center justify-center flex-shrink-0">
                    <FaFacebookF className="text-green-600 text-xl" />
                  </div>
                  <div>
                    <h3 className="text-lg font-bold text-gray-900 mb-2">Fanpage</h3>
                    <a
                      href={contactInfo.fanpage}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-green-500 hover:text-green-600 font-bold transition-colors break-all"
                    >
                      BT Academy - Đào tạo MC & Giọng nói
                    </a>
                  </div>
                </div>
