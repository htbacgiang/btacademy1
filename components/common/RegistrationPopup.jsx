...
const RegistrationPopup = ({ isOpen, onClose, courseSlug = null }) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl max-w-lg md:max-w-2xl w-full mx-4 transform transition-all duration-500 ease-out max-h-[90vh] overflow-y-auto border border-gray-200/50 animate-in fade-in-0 zoom-in-95 slide-in-from-bottom-4 ring-1 ring-white/20">
        {/* Close Button enhanced */}
        <button
          onClick={onClose}
          className="absolute bg-slate-500 top-3 right-3 w-7 h-7 flex items-center justify-center text-gray-100 hover:text-white hover:bg-red-500 rounded-full transition-all duration-300 z-10 shadow-lg hover:shadow-xl hover:scale-110"
        >
        ...
        {/* Header simplified */}
        <div className="px-4 pt-4 pb-3 bg-gradient-to-r from-green-600 to-emerald-600 rounded-t-2xl border-b border-green-700 relative overflow-hidden">
          ...
          <p className="text-white/90 text-xs drop-shadow-sm">
            Điền thông tin để chúng tôi tư vấn khóa học phù hợp
          </p>
        </div>
          ...
          <div className="px-4 mb-3 py-2 animate-in slide-in-from-top-2 duration-300">
            <div className={`px-3 py-2 rounded-lg text-xs flex items-center space-x-2 shadow-sm border ${
              ...
              <div className={`w-2 h-2 rounded-full shadow-sm ${
                messageType === "success" ? "bg-green-500" : "bg-rose-500"
              }`}></div>
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="group">
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500/50 focus:border-green-500 transition-all duration-300 bg-white hover:border-gray-300 text-sm shadow-sm hover:shadow-md focus:shadow-lg"
                  required
                  disabled={isLoading}
                />
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="group">
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className="w-full px-3 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-600/50 focus:border-green-600 transition-all duration-300 bg-white hover:border-gray-300 text-sm shadow-sm hover:shadow-md focus:shadow-lg"
                  required
                  disabled={isLoading}
                />
              </div>
            ...
            <div className="group">
              ...
              <textarea
                ...
                onChange={handleInputChange}
                rows={2}
                className="w-full px-3 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500/50 focus:border-green-500 transition-all duration-300 resize-none bg-white hover:border-gray-300 text-sm shadow-sm hover:shadow-md focus:shadow-lg"
                disabled={isLoading}
              />
            </div>
        ...
        <div className="px-4 pb-3 py-2 bg-gray-50 rounded-b-2xl border-t border-gray-200">
          <div className="flex items-center justify-center space-x-1 text-xs text-gray-600">
            ...
            <span>
              ...
              <a href="/chinh-sach-bao-mat" className="text-green-600 hover:text-green-700 hover:underline transition-colors duration-200 font-medium">
                chính sách bảo mật
              </a>
            </span>
          </div>
