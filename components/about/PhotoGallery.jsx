  ...
  return (
    <div className="bg-gradient-to-br from-white via-gray-50 to-gray-100 py-16">
      <div className="container mx-auto px-4">
          ...
          <div className="fixed inset-0 bg-black bg-opacity-90 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative max-w-5xl max-h-full flex flex-col items-center">
              ...
              <button
                ...
                className="absolute top-2 right-2 text-white hover:text-green-200 transition-colors z-20 bg-green-600 hover:bg-green-700 rounded-full p-2 shadow-lg"
                title="Đóng ảnh"
              >
        ...
        <div className="absolute top-48 right-16 w-3 h-3 bg-emerald-500 rounded-full animate-ping delay-500 opacity-30"></div>
        <div className="absolute bottom-36 left-1/3 w-1 h-1 bg-green-600 rounded-full animate-ping delay-1000 opacity-30"></div>
      </div>
    </div>
  );
};
