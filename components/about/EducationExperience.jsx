...
const EducationExperience = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-gray-50 via-white to-green-50 py-16">
      <div className="container mx-auto px-4">
          ...
          <div>
            ...
            <div className="space-y-6">
              {experienceData.map((exp) => (
                <div key={exp.id} className="relative pl-8 pb-8 border-l-2 border-green-200 last:border-l-0 last:pb-0">
                  <div className="absolute -left-2 top-0 w-4 h-4 bg-green-600 rounded-full"></div>
                  ...
                  <div className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow duration-300 border border-green-100">
                    ...
                    <h5 className="text-green-600 font-semibold mb-2">{exp.company}</h5>
        ...
        <div className="absolute top-64 right-24 w-3 h-3 bg-emerald-500 rounded-full animate-ping delay-500 opacity-40"></div>
        <div className="absolute bottom-48 left-1/3 w-1 h-1 bg-green-600 rounded-full animate-ping delay-1000 opacity-40"></div>
      </div>
    </div>
  );
};
