  ...
  return (
    <div className="text-gray-900">
      <div className="container mx-auto px-4 py-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
              <div className="space-y-4">
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-gray-900">Thái Nguyên</span>
                </div>
              </div>
              <div className="space-y-4">
                <div className="flex items-center">
                  <span className="text-gray-600 font-medium w-24">Email:</span>
                  <span className="text-green-600">thuylb@btacademy.com.vn</span>
                </div>
                <div className="flex items-center">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <a 
                  ...
                  className="w-12 h-12 bg-gray-200 hover:bg-green-600 text-gray-700 hover:text-white rounded-full flex items-center justify-center transition-all duration-300 transform hover:scale-110 hover:shadow-lg"
        ...
        <div className="absolute top-40 right-20 w-3 h-3 bg-emerald-500 rounded-full animate-ping delay-500 opacity-60"></div>
        <div className="absolute bottom-32 left-1/4 w-1 h-1 bg-green-600 rounded-full animate-ping delay-1000 opacity-60"></div>
        <div className="absolute bottom-20 right-1/3 w-2 h-2 bg-yellow-400 rounded-full animate-ping delay-1500 opacity-60"></div>
      </div>
    </div>
  );
};
